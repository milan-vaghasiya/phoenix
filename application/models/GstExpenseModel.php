...
class GstExpenseModel extends MasterModel{
    ...
    public function getDTRows($data){
        ...
        $data['select'] = "trans_main.id, trans_main.trans_number, trans_main.trans_date, trans_main.party_id, trans_main.party_name, trans_main.taxable_amount, trans_main.gst_amount, trans_main.net_amount, trans_main.trans_status, company_info.company_code";
    ...
    public function save($data){
        try{
            ...
            if(!empty($data['id'])):
                $dataRow = $this->getGstExpense(['id'=>$data['id'],'itemList'=>0]);
    ...
    public function delete($id){
        try{
            ...
            $dataRow = $this->getGstExpense(['id'=>$id,'itemList'=>0]);
