...
class GroupMaster extends MY_Controller{
    ...
    public function getDTRows(){
		...
		$result = $this->groupMaster->getDTRows($data);
    ...
    public function addGroup(){
        $this->data['masterGroupList'] = $this->groupMaster->getGroupList();
    ...
    public function save(){
        ...
        if(!empty($errorMessage)):
            ...
            $this->printJson($this->groupMaster->save($data));
        endif;
    }

    public function edit(){
        $data = $this->input->post();
        $this->data['dataRow'] = $this->groupMaster->getGroup($data);
        $this->data['masterGroupList'] = $this->groupMaster->getGroupList();
        $this->load->view($this->formPage,$this->data);
    }
    ...
    public function delete(){
        ...
        if(empty($id)):
            ...
            $this->printJson($this->groupMaster->delete($id));
        endif;
    }
}
?>