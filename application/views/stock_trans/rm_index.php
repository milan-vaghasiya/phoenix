            ...
            <div class="col-sm-12">
				<div class="page-title-box">
                    <!-- <div class="float-start">
                        ...
                        <a href="<?= base_url($headData->controller."/rmStock") ?>" class="btn btn-outline-primary active">RM Stock Inward</a>
                    </div> -->
                    
					<div class="float-end">
                        <?php
                            $addParam = "{'postData':{'item_type':3},'modal_id' : 'bs-right-md-modal', 'call_function':'addStock', 'form_id' : 'addStock', 'title' : 'Add Stock'}";
                        ?>
                        ...
                        <?php
                            $importParam = "{'postData':{'item_type':3},'modal_id' : 'modal-md', 'call_function':'importStock', 'form_id' : 'importStock', 'button' : 'close', 'title' : 'Import RM Stock'}";
                        ?>
						...
						<?php
                            $transferParam = "{'postData':{'item_type':'3'},'modal_id' : 'bs-right-md-modal', 'call_function':'stockTransfer', 'fnsave':'saveStockTransfer', 'form_id' : 'stockTransfer', 'title' : 'Add Stock Transfer'}";
                        ?>
                    ...
                    <h4 class="card-title text-left">RM Stock Inward</h4>
				</div>
            </div>
		</div>
        <div class="row">
					...
					<div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id='rmStockTable' class="table table-bordered ssTable ssTable-cf" data-url='/getDTRows/3'></table>
                            </div>
                        </div>
					</div>
				</div>
