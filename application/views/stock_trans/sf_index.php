        ...
        <div class="row">
            <div class="col-sm-12">
				<div class="page-title-box">    
					...
					<div class="float-end">
                        <?php
                            $addParam = "{'postData':{'item_type':'4'},'modal_id' : 'bs-right-md-modal', 'call_function':'addStock', 'form_id' : 'addStock', 'title' : 'Add Stock'}";
                        ?>
                        ...
                        <?php
                            $importParam = "{'postData':{'item_type':'4'},'modal_id' : 'modal-md', 'call_function':'importStock', 'form_id' : 'importStock', 'button' : 'close', 'title' : 'Import FG Stock'}";
                        ?>
						...
						<?php
                            $transferParam = "{'postData':{'item_type':'4'},'modal_id' : 'bs-right-md-modal', 'call_function':'stockTransfer', 'fnsave':'saveStockTransfer', 'form_id' : 'stockTransfer', 'title' : 'Add Stock Transfer'}";
                        ?>
                    ...
                    <h4 class="card-title text-left">Semi Finish Stock Inward</h4>
				</div>
            </div>
		</div>
        <div class="row">
					...
					<div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id='sfItemStockTable' class="table table-bordered ssTable ssTable-cf" data-url='/getDTRows/4'></table>
                            </div>
                        </div>
					</div>
				</div>
