    ...
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-md-<?=($this->cm_id_count > 1)?"12":"8"?> form-group">
                ...
                <select name="item_id" id="item_id" class="form-control basic-select2 itemDetails" data-res_function="resItemDetail">
                    <option value="">Select Item</option>
                    <?=getItemListOption($itemList)?>
                </select>               
            </div>

            <div class="col-md-12 form-group machineList">
                <label for="machine_id">Machine</label>
                <select name="machine_id" id="machine_id" class="form-control basic-select2 req">
            ...
            <div class="col-md-4 form-group">
                ...
                <input type="text" name="total_box" id="total_box" class="form-control floatOnly calculateQty req" value="">
            </div>
            ...
            <div class="col-md-4 form-group">
                ...
                <input type="text" name="qty" id="qty" class="form-control floatOnly calculateQty req" value="">
            </div>
