			...
			<div class="col-sm-12">
				<div class="page-title-box">					
					<ul class="nav nav-pills">
						...
						<li class="nav-item"> <button onclick="statusTab('leaveApproveTable',4);" class=" btn waves-effect waves-light btn-outline-danger" style="outline:0px" data-toggle="tab" aria-expanded="false">Rejected</button> </li>        
					</ul>
				</div>
			</div>
		</div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
							<table id="leaveApproveTable" class="table table-bordered ssTable ssTable-cf" data-url="/getDTRows"></table>
                        </div>
                    </div>
                </div>
            </div>
