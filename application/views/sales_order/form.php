                    ...
                    <div class="card">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 form-group">
                                            ...
                                            <select name="ship_to_id" id="ship_to_id" class="form-control basic-select2">
                        ...
                        <div class="card-footer bg-facebook">
                            <div class="col-md-12"> 
                                ...
                                <button type="button" class="btn waves-effect waves-light btn-success float-right save-form" onclick="customStore({'formId':'saveSalesOrder'});" ><i class="fa fa-check"></i> <?=(!empty($is_approve))?"Acccept":"Save"?> </button>
