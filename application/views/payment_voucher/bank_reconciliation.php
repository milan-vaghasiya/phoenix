					...
					<div class="float-end">
                        <div class="input-group">
                            ...
                            <div class="input-group-append ml-2">
                                <button type="button" class="btn waves-effect waves-light btn-success float-right refreshReportData" id="loadData" title="Load Data">
    ...
    $(document).on('click','#loadData',function(e){
		...
		if(valid){
            $.ajax({
                ...
                data: {acc_id:acc_id, from_date:from_date, to_date:to_date,status:status,cm_id:cm_id},
				type: "POST",
				dataType:'json',
