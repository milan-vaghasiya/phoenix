                    ...
                    <div class="card">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 form-group">
                                            ...
                                            <input type="hidden" name="trans_number" id="trans_number" class="form-control req" value="<?=(!empty($dataRow->trans_number))?$dataRow->trans_number:((!empty($trans_number))?$trans_number:"")?>" readonly>
                        ...
                        <div class="card-footer bg-facebook">
                            <div class="col-md-12"> 
                                ...
                                <button type="button" class="btn waves-effect waves-light btn-success float-right save-form" onclick="customStore({'formId':'saveGstIncome'});" ><i class="fa fa-check"></i> Save </button>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <select name="item_id" id="item_id" class="form-control basic-select2 partyDetails" data-res_function="resItemDetail" data-party_category="4">
