...
$(document).ready(function(){
	...
	setTimeout(function(){$("#cm_id").trigger('change'); $(".calculateAmount").trigger('change');},500);
    ...
    $(document).on('change','#cm_id',function(){
        ...
        $.ajax({
            url : base_url + 'paymentVoucher/getUnitWiseBankList',
            type : 'post',
            data : {cm_id:cm_id, vou_acc_id : $("#vou_acc_id :selected").val()},
            dataType : 'json',
        }).done(function(response){
            $("#vou_acc_id").html("");
