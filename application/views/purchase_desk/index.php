        ...
        <div class="row">
            <div class="col-sm-12">
				<div class="page-title-box">
					...
					<div class="float-end">
						<?php
							$addParam = "{'modal_id' : 'bs-right-lg-modal', 'call_function':'addEnquiry', 'form_id' : 'addEnquiry', 'title' : 'New Enquiry', 'fnsave' : 'saveEnquiry'}";

                            $compareParam = "{'modal_id' : 'bs-right-xl-modal', 'call_function' : 'quotationComparison', 'form_id' : 'quotationComparison', 'title' : 'Quotation Comparison', 'button' : 'close'}";
						?>
                        ...
                        <button type="button" class="btn waves-effect waves-light btn-outline-primary float-right mr-5 permission-write press-add-btn" onclick="modalAction(<?=$compareParam?>);"><i class="fas fa-exchange-alt"></i> Quotation Comparison</button>
					</div>
				</div>
            </div>
		</div>
