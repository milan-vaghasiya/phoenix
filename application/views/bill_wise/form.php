                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?=moneyFormatIndia(floatval($dataRow->net_amount))?></td>
                                <td><?=moneyFormatIndia(floatval($dataRow->pending_amount))?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                                ...
                                if(!empty($unsettledTrans)):
                                    ...
                                    foreach($unsettledTrans as $row):
                                        ...
                                        echo '<tr>
                                            ...
                                            <td>'.moneyFormatIndia(floatval($row->pending_amount)).'</td>
                                            <td>
