				...
				<div class="col-12">
                    <div class="card">
                            ...
                            <form autocomplete="off" id="saveSalesEnquery" data-res_function="resSaveEnquery" enctype="multipart/form-data">
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 form-group <?=($this->cm_id_count == 1)?"hidden":""?>">
                        ...
                        <div class="card-footer bg-facebook">
                            <div class="col-md-12">                                
                                <button type="button" class="btn waves-effect waves-light btn-success float-right save-form" onclick="customStore({'formId':'saveSalesEnquery'});" ><i class="fa fa-check"></i> Save</button>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <select name="item_id" id="item_id" class="form-control basic-select2 itemDetails itemOptions" data-res_function="resItemDetail" data-item_type="1" data-price_structure_id="">
