        ...
        <div class="row">
            <div class="col-12">
                ...
                <table class="table item-list-bb" style="margin-top:10px;">
                    ...
                    <tbody>
                        <?php
                            $i=1;$totalQty = $totalBoxQty = 0;$migst=0;$mcgst=0;$msgst=0;
                                    ...
                                    if ($row->position == 1) :
                                        if($rwspan == 0):
                                            ...
                                            $beforExp .= '<tr>
                                                ...
                                                <td class="text-right">'.sprintf('%.2f',$expAmt).$perText.'</td>
                                            </tr>';
                                        endif;
                                        $rwspan++;
                                    endif;
                            ...
                            foreach ($taxList as $taxRow) :
                                ...
                                $perText = '';
                                if(in_array($taxRow->map_code,['igst','cgst','sgst'])):
                                    $perText = ' @'.(($dataRow->gst_type == 1)?floatVal($migst/2):$migst).'%';
                                elseif(!empty($dataRow->{$taxRow->map_code.'_per'}) && floatval($dataRow->{$taxRow->map_code.'_per'}) > 0):
                                    $perText = ' @'.(floatval($dataRow->{$taxRow->map_code.'_per'})).'%';
                                endif;
