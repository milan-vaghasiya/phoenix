    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-2 form-group">
                ...
                <select name="tax_class" id="tax_class" class="form-control basic-select2 req" data-selected="<?=(!empty($dataRow->tax_class))?$dataRow->tax_class:""?>">
            ...
            <div class="col-md-4 form-group">
                ...
                <select name="sp_acc_id" id="sp_acc_id" class="form-control basic-select2 req">
