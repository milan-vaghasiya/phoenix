                    ...
                    <div class="card">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 form-group <?=($this->cm_id_count == 1)?"hidden":""?>">
                                            ...
                                            <select name="cm_id" id="cm_id" class="form-control" data-selected_cm_id="<?=(!empty($dataRow->cm_id))?$dataRow->cm_id:""?>" data-append_id="doc_no">
                                            ...
                                            <div class="float-right">	
                                                ...
                                                <span class="float-right m-r-10">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY" x-placement="start-left" style="left: -87px;">
                                                        ...
                                                        <a class="dropdown-item getPendingGI" href="javascript:void(0)">+ Gate Inward</a>
                                                    </div>
                                                </span>
                                            </div>
                                        ...
                                        <label for="attachments">Attachment</label>
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="form-control custom-file-input" name="attachment" id="attachment" accept="*" />
                                                </div>
                                                <?php if(!empty($dataRow->attachment)): ?>
                                                    <div class="input-group-append">
                                                        <a href="<?=base_url("assets/uploads/purchase_invoice/".$dataRow->attachment)?>" class="btn btn-info" download><i class="fas fa-download"></i></a>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                            <div class="error attachment"></div>
                                        </div>
                                    </div>
                        ...
                        <div class="card-footer bg-facebook">
                            <div class="col-md-12"> 
                                ...
                                <button type="button" class="btn waves-effect waves-light btn-success float-right save-form" onclick="customStore({'formId':'savePurchaseInvoice'});" ><i class="fa fa-check"></i> Save </button>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <select name="item_id" id="item_id" class="form-control basic-select2 itemDetails itemOptions" data-res_function="resItemDetail" data-item_type="2,3">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <input type="hidden" name="org_price" id="org_price" class="form-control floatOnly req" value="0" />
                            </div>
                            <div class="col-md-3 form-group">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <select name="gst_per" id="gst_per" class="form-control calculatePrice basic-select2">
                                    <?php
