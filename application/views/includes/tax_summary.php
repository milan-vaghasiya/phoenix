            ...
            <table id="summaryTable" class="table">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th style="width: 30%;"><div class="ledgerColumn">Ledger</div></th>
                ...
                <tbody>
                    <tr>
                        <td>Sub Total</td>
                        <td><div class="ledgerColumn"></div></td>
                        <td></td>
                        <td></td>
                        <td>
                    ...
                    foreach ($expenseList as $row) :
                        ...
                        if ($row->position == 1) :
                            $beforExp .= '<tr>
                                <td>' . $row->exp_name . '</td>
                                <td><div class="ledgerColumn">' . $options . '</div></td>
                                <td>';
                    ...
                    foreach ($taxList as $taxRow) :
                        ...
                        $ledgerOptions = $ledgerAccess = "";
                        if($taxRow->map_code == "tds"): $ledgerOptions = "tdsLedgerOptions"; $ledgerAccess = "tdsLedger";
                        elseif($taxRow->map_code == "tcs"): $ledgerOptions = "tcsLedgerOptions"; $ledgerAccess = "tcsLedger";
                        endif;

                        $tax .= '<tr class="' . $taxClass . '">
                            <td id="'.$ledgerAccess.'">' . $taxRow->name . '</td>
                            <td><div id="'.$ledgerOptions.'" class="ledgerColumn">' . $options . '</div></td>
                            <td>';
                ...
                <tfoot class="thead-dark">
                    <tr>
                        <th>Net. Amount</th>
                        <th><div class="ledgerColumn"></div></th>
                        <th></th>
                        <th></th>
                        <th>
