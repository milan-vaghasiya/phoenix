                        ...
                        <tbody>
                            ...
                            if (!empty($termsList)) :
                                ...
                                foreach ($termsList as $row) :
                                    ...
                                    if(!empty($termaData)):
                                        if(in_array($row->id, array_column((array)$termaData, 'term_id'))) :
                                            $checked = "checked";
                                            $disabled = "";
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <textarea name="termsData[<?= $i ?>][t_col_2]" id="condition<?= $i ?>" class="form-control" <?= $disabled ?> /><?= $row->conditions ?></textarea>
                                        </td>
                                    </tr>
                                <?php
                                    $i++;
