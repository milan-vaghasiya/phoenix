    ...
    <div class="col-md-12">
            ...
            <div class="col-md-12">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <th style="width:15%"><?=$itemData->item_code?></th>
                        <th style="width:15%">Item Name</th>
                        <th><?=$itemData->item_name.' '.$itemData->category_name?></th>                        
                    </tr>
                </table>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-4 form-group">
                ...
                <select name="ref_item_id" id="ref_item_id" class="form-control basic-select2">
