                    ...
                    <div class="page-title-box">
                        <div class="float-start">
                            <ul class="nav nav-pills">
                                <a href="<?= base_url($headData->controller) ?>" class="btn waves-effect waves-light btn-outline-primary  permission-write"> Web Permission</a>
								<a href="<?= base_url($headData->controller . "/appPermission/") ?>" class="btn waves-effect waves-light btn-outline-primary permission-write"> App Permission</a>
                                <a href="<?= base_url($headData->controller . "/reportPermission/") ?>" class="btn waves-effect waves-light btn-outline-primary permission-write active"> Report Permission</a>
