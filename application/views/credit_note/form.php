                    ...
                    <div class="card">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="hiddenInput">
                                            ...
                                            <input type="hidden" name="port_code" id="port_code" value="<?=(!empty($dataRow->port_code))?$dataRow->port_code:""?>">
                                        ...
                                        <div class="col-md-<?=($this->cm_id_count > 1)?"4":"5"?> form-group">
                                            ...
                                            <select name="party_id" id="party_id" class="form-control basic-select2 partyDetails partyOptions req" data-res_function="resPartyDetail" data-party_category="1,2,3">
                                        ...
                                        <div class="col-md-2 form-group">
                                            ...
                                            <select name="order_type" id="order_type" class="form-control" data-selected_order_type="<?=(!empty($dataRow->order_type))?$dataRow->order_type:""?>">
                                        ...
                                        <div class="col-md-3 form-group itcInput">
                        ...
                        <div class="card-footer bg-facebook">
                            <div class="col-md-12"> 
                                ...
                                <button type="button" class="btn waves-effect waves-light btn-success float-right save-form" onclick="customStore({'formId':'saveCreditNote'});" ><i class="fa fa-check"></i> Save </button>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <div class="float-right addItemOption">	
                                    <span class="dropdown float-right">
                                        <a class="text-primary font-bold waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" datatip="Progress" flow="down">+ Add New</a>
                                ...
                                <select name="item_id" id="item_id" class="form-control basic-select2 itemDetails itemOptions" data-res_function="resItemDetail" data-item_type="1,2,3">
                            ...
                            <div class="col-md-4 form-group price">
                                <label for="price">Price</label>
                                <input type="text" name="price" id="price" class="form-control floatOnly calculatePrice req" value="0" />
                            </div>
                            <div class="col-md-4 form-group disc_per">
                                <label for="disc_per">Disc. (%)</label>
                                <input type="text" name="disc_per" id="disc_per" class="form-control floatOnly calculatePrice" value="0">
                            </div>
                            <div class="col-md-4 form-group unit_id">
							...
							<div class="col-md-4 form-group hsn_code">
                            ...
                            <div class="col-md-4 form-group gst_per">
                                <label for="gst_per">GST Per.(%)</label>
                                <select name="gst_per" id="gst_per" class="form-control basic-select2 calculatePrice">
                                    <?php
...
var itemList = '<?=getItemListOption($itemList)?>';
var itemLedgerList = '<?=getPartyListOption($itemLedgerList)?>';
</script>
<?php
